...
public class ArmorHRListFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.armor_hr_list_fragment, parent, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = Objects.requireNonNull(getActivity()).findViewById(R.id.rvArmorHR);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        Cursor c = DatabaseHelper.getDatabase(getContext()).rawQuery("SELECT * FROM armor_list WHERE rank = 'hr'", null);
