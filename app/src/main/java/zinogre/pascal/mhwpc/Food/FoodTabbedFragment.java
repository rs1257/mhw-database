...
public class FoodTabbedFragment extends BaseFragment {
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.addFragment(new FoodSkillListFragment(), "Skills");
        adapter.addFragment(new FoodIngredientListFragment(), "Ingredients");
