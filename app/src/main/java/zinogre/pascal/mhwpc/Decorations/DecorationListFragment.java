...
public class DecorationListFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.decoration_list_fragment, parent, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        DecorationListAdapterCursor adapter;
        ...
        RecyclerView recyclerView = Objects.requireNonNull(getActivity()).findViewById(R.id.rvDecorations);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        Cursor c = DatabaseHelper.getDatabase(getContext()).rawQuery("SELECT * FROM decoration_list", null);
        adapter = new DecorationListAdapterCursor(getContext(), c, listener);
