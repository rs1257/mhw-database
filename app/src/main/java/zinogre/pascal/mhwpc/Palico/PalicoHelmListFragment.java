...
public class PalicoHelmListFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.palico_helm_list_fragment, parent, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = Objects.requireNonNull(getActivity()).findViewById(R.id.rvPalicoHelm);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        Cursor c = DatabaseHelper.getDatabase(getContext()).rawQuery("SELECT * FROM palico_armor_list WHERE armorType = 'helm'", null);
