...
public class PalicoGadgetListFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.palico_gadget_list_fragment, parent, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = Objects.requireNonNull(getActivity()).findViewById(R.id.rvPalicoGadget);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        Cursor c = DatabaseHelper.getDatabase(getContext()).rawQuery("SELECT * FROM palico_gadget_list", null);
